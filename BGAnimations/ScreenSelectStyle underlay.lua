local t = Def.ActorFrame{
	Def.Quad{
		...
		InitCommand=function(self)
			self:x(SCREEN_CENTER_X):y(SCREEN_CENTER_Y*0.625):zoomto(SCREEN_WIDTH,2):diffuserightedge(HSV(192,1,0.8))
		end;
	...
	Def.Quad{
		Name="BottomLine";
		InitCommand=function(self)
			self:x(SCREEN_CENTER_X):y(SCREEN_CENTER_Y*1.375):zoomto(SCREEN_WIDTH,2):diffuseleftedge(HSV(192,1,0.8))
		end;
		OffCommand=function(self)
