local t = Def.ActorFrame{
	Def.Quad{
		...
		InitCommand=function(self)
			self:x(SCREEN_CENTER_X):y(SCREEN_CENTER_Y*0.2825):zoomto(SCREEN_WIDTH,2):diffuseleftedge(HSV(192,1,0.8)):cropright(1)
		end;
	...
	Font("mentone","24px") .. {
		...
		InitCommand=function(self)
			self:x(SCREEN_LEFT+32):y(SCREEN_CENTER_Y*0.255):zoomx(0.8):halign(0):valign(1):shadowlength(1):zoomy(0):strokecolor(color("0,0,0,0"))
		end;
		OnCommand=function(self)
	...
	Def.Quad{
		Name="BottomLine";
		InitCommand=function(self)
			self:x(SCREEN_CENTER_X):y(SCREEN_CENTER_Y*1.675):zoomto(SCREEN_WIDTH,2):diffuserightedge(HSV(192,1,0.8)):cropleft(1)
		end;
		OnCommand=function(self)
